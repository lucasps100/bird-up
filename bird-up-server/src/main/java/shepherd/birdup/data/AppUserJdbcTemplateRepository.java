...
import shepherd.birdup.data.mappers.AppUserMapper;
...
public class AppUserJdbcTemplateRepository implements AppUserRepository {
    ...
    public AppUser create(AppUser user) {
        ...
        updateRoles(user);
        // TODO: Consider creating profile here;
        return user;
    }
    ...
    public void update(AppUser user) {
        ...
        jdbcTemplate.update(sql,
                user.getUsername(), user.isEnabled(), user.getId());
    ...
    public void updateRoles(AppUser user) {
        ...
        for (GrantedAuthority role : authorities) {
            ...
            jdbcTemplate.update(sql, user.getId(), role.getAuthority());
        }
    }
