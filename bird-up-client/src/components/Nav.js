    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg" id="nav">
            ...
            <ul className="navbar-nav mr-auto">        
                <div class="search nav-item form-inline">
                    <form onSubmit={handleSubmit} className= "form-inline my-2 my-lg-0">
                        <input id="query" type="text" placeholder="Search..." name="query" onChange={handleChange}></input>
            ...
            {user ? (
                ...
                <li className="nav-item">
                    <NavLink id="linkProfile" to="/profile" className="nav-link">Profile</NavLink>
                </li>
                <li className="nav-item">
            ...
            <>
                <li className='nav-item'>
                    <NavLink id='login' className="nav-link" to='/login'>Log In</NavLink>
                </li>
                <li className='nav-item'>
                    <NavLink id='register' className="nav-link" to='/register'>Sign Up</NavLink>
                </li>
            </>
            )}
            </ul>
